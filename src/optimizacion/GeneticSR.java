...
public class GeneticSR {
    ...
    */
    ...
    /**
    Metodo crossover 
    *Genera primero la cantidad de parejas a producir usando el crossoverRate
    *dado por la terminal y la funcion floor((crossoverRate*populationSize)/5/2)
    */
    ...
    */
     ...
     * Metodo swap
     * 
     * Realiza el bubble sort descrito por Runnarson. Fue creado usando el pseudocodigo de swap
     * encontrado en la descripcion de Genetic Algorithm SR en Copasi.
     */
     ...
     * Metodo cruceSexual
     * 
     * Realiza un cruce entre dos padres. La cantidad de parametros que se cruzan
     * son un numero entre 0 a 4 segun el algoritmo.
     * 
     * @param padre El primer padre a cruzar
     * @param madre El segundo padre a cruzar
     * @param id Un identificador para el objeto Solucion
     * @return el hijo generado
     */
    ...
    /**
     * Metodo createPopulationSR
     * 
     * El algoritmo genetico completo. Utiliza todos los metodos de esta clase.
     *  
     * @return una lista con la nueva generacion
     */
    ...
    public List<Solucion> createPopulationSR() {
       ...
       print.printResults("afterSwap", poblacion, 1);
        ...
        int id = 0;
        if(crossoverCount!=0){
        for (int i = poblacion.size()-1; i > poblacion.size()-crossoverCount; i = i - 2) {
